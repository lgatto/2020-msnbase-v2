...
proteomics identification data. The package enables manipulation of
these data (for example subsetting, filtering, or accessing specific
parts thereof), a detailed step-by-step processing (for example
smoothing and centroiding of raw data, or normalisation and imputation
